...
parser.add_argument("--n_trials", type=int, default=2,     help="Number of outer trials (read-in)")
...
def run_inner_trial(
    ...
    with lock:
        ...
        reservoir_records.append(
            (outer + 1, inner + 1, reservoir_weights)
        )
...
def main():
    ...
    print("\nFixed Read-In | Variable Reservoir (CORRECTED)\n")
    ...
    print("\nSaved all SC1 outputs successfully.")
