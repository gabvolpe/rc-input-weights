...
def create_base_model(input_shape, output_shape):
    ...
    model_rc.add(RandomReservoirLayer(
        ...
        leakage_rate=0.1, fraction_input=0.5, spec_rad=0.9 # 50% of values masked
        ))
...
def main():
    ...
    sheet_name_median = 'Exp2_NARMA10_Median'
    sheet_name_iqr = 'Exp2_NARMA10_IQR'
