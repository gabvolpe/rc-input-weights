...
def generate_fourier_weights(n_nodes, n_inputs, max_freq=10):
...
def main():
    ...
    sheet_name_median = 'Exp3_Lorenz_Median'
    sheet_name_iqr = 'Exp3_Lorenz_IQR'
    ...
    for outer in range(n_trials): 
        ...
        for inner in range(n_inner_trials):
            ...
            # Laplace weights
            input_laplace_weights = sample_laplace_weights((500, 3))
